# DeFi Vault Safety Brief — 2026-09-14
...
## New since last brief (2026-09-13)

Nothing new since 2026-09-13.
...
- **Term Finance governance attack ($8.5M, Aug 23-24)** — no technical postmortem, no reimbursement plan, and no repayment timeline confirmed yet; a portion of drained funds previously reported "gone dark" via mixers/OTC. Not Steakhouse/Maple, no Morpho core bad debt. [CryptoTimes](https://www.cryptotimes.io/2026/08/23/term-finance-loses-8-5m-after-attacker-hijacks-dao-governance-vote/)
...
**Bottom line:** Holdings clean, another quiet 24h with no new safety or operational items — the Aave governance outcome, the unconfirmed Brinztech report, Term Finance reimbursement, and the frozen msY/USDC Morpho market remain the only open threads, none touching Steakhouse or Maple vaults.
