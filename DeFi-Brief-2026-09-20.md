# DeFi Vault Safety Brief — 2026-09-20
...
## New since last brief (2026-09-19)

Nothing new since 2026-09-19.
...
- **Term Finance governance attack ($8.5M, Aug 23-24)** — Term Labs shut down the exploited Meta Vaults and says it will "explore pathways" to cover any shortfall, but has not disclosed remaining vault balances, a compensation plan, or a repayment timeline. Not Steakhouse/Maple, no Morpho core bad debt. [crypto.news](https://crypto.news/term-finance-closes-meta-vaults-after-estimated-attack/)
...
**Bottom line:** Holdings clean, quiet 24h with nothing new — Aave's governance vote outcome, the Umbrella proposal, the Monad USDT0 liquidity crunch, the unconfirmed Brinztech report, Term Finance's unresolved depositor reimbursement, and the frozen msY/USDC Morpho market remain the only open threads.
