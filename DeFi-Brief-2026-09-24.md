# DeFi Vault Safety Brief — 2026-09-24
...
## New since last brief (2026-09-23)

Nothing new since 2026-09-23.
...
- **Term Finance governance attack ($8.5M, Aug 23-24)** — Term Labs shut down the exploited Meta Vaults and blocked new deposits (withdrawals still open); still no technical postmortem or repayment timeline, though Term says ~556 ETH was recovered, cutting the net loss to ~362 ETH (~$650k), with a pledge to fully reimburse affected users. Not Steakhouse/Maple, no Morpho core bad debt. [crypto.news](https://crypto.news/term-labs-recovers-fixed-rate-positions-after-8-5m-governance-attack/)
...
**Bottom line:** Holdings clean, another quiet 24h — Aave's emergency-powers vote outcome, the Umbrella proposal, the Monad USDT0 liquidity crunch, the unconfirmed Brinztech report, Term Finance's unresolved depositor reimbursement, and the frozen msY/USDC Morpho market remain the only open threads, none touching Steakhouse or Maple.
